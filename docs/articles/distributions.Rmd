...
Let X be the IQ of a randomly selected student of a school. Assume X ~ N(90, 12). 
What is the probability that a randomly selected student has an IQ below 70?

```{r norm_prob1, fig.width=7, fig.height=7, fig.align='centre'}
norm_prob(70, mean = 90, sd = 12)
```

What is the probability that a randomly selected student has an IQ above 140?

```{r norm_prob2, fig.width=7, fig.height=7, fig.align='centre'}
norm_prob(140, mean = 90, sd = 12, type = 'upper')
```
...
norm_prob(c(96, 124), mean = 90, sd = 12, type = 'both')
```
...
What is the fifteenth percentile?

```{r f_per2, fig.width=7, fig.height=7, fig.align='centre'}
f_per(0.15, 4, 5, 'lower')
```
...
What is the probability that the value of T is less than 2.306?
 
```{r t_prob1, fig.width=7, fig.height=7, fig.align='centre'}
t_prob(2.306, 6, 'lower')
```

What is the probability that the value of T is greater than 2.306?
 
```{r t_prob2, fig.width=7, fig.height=7, fig.align='centre'}
t_prob(2.306, 6, 'upper')
```

What is the probability that the value of T is between -2.306 and 2.306?
 
```{r t_prob3, fig.width=7, fig.height=7, fig.align='centre'}
t_prob(2.306, 6, 'both')
```

What is the probability that the absolute value of T is greater than 2.306?

```{r t_prob4, fig.width=7, fig.height=7, fig.align='centre'}
t_prob(2.306, 6, 'interval')
```
